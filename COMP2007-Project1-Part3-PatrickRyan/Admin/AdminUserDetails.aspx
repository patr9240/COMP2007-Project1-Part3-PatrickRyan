<%@ Page Title="AdminUserDetails" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminUserDetails.aspx.cs" Inherits="COMP2007_Project1_Part3_PatrickRyan.Admin.AdminUserDetails" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <!-- 
     AdminUserDetails.aspx
     Patrick Ross - Ryan Jameson
     COMP2007_Project1_Part3_PatrickRyan
     This is the admin user editing/adding page for NorthStar Tracking
    -->
    <div class="container">
        <div class="row">
