<%@ Page Title="AdminRegisterTeams" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminRegisterTeams.aspx.cs" Inherits="COMP2007_Project1_Part3_PatrickRyan.Admin.AdminRegisterTeams" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <!-- 
     AdminRegisterTeams.aspx
     Patrick Ross - Ryan Jameson
     COMP2007_Project1_Part3_PatrickRyan
     This is the admin Team registeration page for NorthStar Tracking
    -->
    <div class="container">
        <div class="row">
